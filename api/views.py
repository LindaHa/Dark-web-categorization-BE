...
pages = {
    ...
    'xordoquy.onion/drugs': Page(id='a077a831-6d9f-4d9c-ab1d-9ec3fb6abd31',content='Sleep less', url='xordoquy.onion/drugs', links=[Link(link='xordoquy.onion/drugs'), Link(link='wow.onion/drugs'), Link(link='road.onion/drugs')]),
